...
const Profile = () => {
  ...
  useEffect(() => {
    fetch(`https://loon-backend.onrender.com/api/get-user/${user.sub}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch(`https://loon-backend.onrender.com/api/user-reviews/${user.sub}`)
      .then((res) => res.json())
      .then((data) => {
        if (data.status === 200) {
  ...
  const deleteHandler = (e, id) => {
    e.preventDefault();
    fetch("https://loon-backend.onrender.com/api/delete-review", {
      method: "DELETE",
      headers: {
  ...
  const deleteFavHandler = (e, id) => {
    e.preventDefault();
    fetch("https://loon-backend.onrender.com/api/delete-favourite", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
